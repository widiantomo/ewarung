package id.web.kmis.e_warung.materialnavigationdrawer.util;
...
import id.web.kmis.e_warung.materialnavigationdrawer.util.*;
...
public class MaterialDrawerLayout extends DrawerLayout {
    ...
    public void setMultipaneSupport(boolean support) {
        if(id.web.kmis.e_warung.materialnavigationdrawer.util.Utils.isTablet(this.getResources())) {
