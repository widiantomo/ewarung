...
import id.web.kmis.e_warung.warung.master_child.ChildFragment;

/**
 * Created by neokree on 20/01/15.
 */
public class StokFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ((MaterialNavigationDrawer)this.getActivity()).setFragmentChild(new ChildFragment(),"Stok");
    }
}
